...
return [
    ...
    "af" => [
        "Total Contributions" => "Totale Bydraes",
        "Current Streak" => "Huidige Reeks",
        "Longest Streak" => "Langste Reeks",
        "Week Streak" => "Week Reeks",
        "Longest Week Streak" => "Langste Week Reeks",
        "Present" => "Huidig",
        "Excluding {days}" => "Uitsluitend {days}",
    ],
    "sq" => [
        "Total Contributions" => "Kontributet Totale",
        "Current Streak" => "Seria Aktuale",
        "Longest Streak" => "Seria Më e Gjatë",
        "Week Streak" => "Seria Javore",
        "Longest Week Streak" => "Seria Javore Më e Gjatë",
        "Present" => "Tani",
        "Excluding {days}" => "Duke përjashtuar {days}",
    ],
    "az" => [
        "Total Contributions" => "Ümumi Töhfələr",
        "Current Streak" => "Cari Ardıcıllıq",
        "Longest Streak" => "Ən Uzun Ardıcıllıq",
        "Week Streak" => "Həftəlik Ardıcıllıq",
        "Longest Week Streak" => "Ən Uzun Həftəlik Ardıcıllıq",
        "Present" => "İndi",
        "Excluding {days}" => "{days} istisna olmaqla",
    ],
    "eu" => [
        "Total Contributions" => "Ekarpen Guztira",
        "Current Streak" => "Uneko Sekuentzia",
        "Longest Streak" => "Sekuentziarik Luzeena",
        "Week Streak" => "Asteko Sekuentzia",
        "Longest Week Streak" => "Asteko Sekuentziarik Luzeena",
        "Present" => "Orain",
        "Excluding {days}" => "{days} baztertuta",
    ],
    "be" => [
        "Total Contributions" => "Усяго Унёскаў",
        "Current Streak" => "Бягучая Серыя",
        "Longest Streak" => "Найдаўжэйшая Серыя",
        "Week Streak" => "Тыднёвая Серыя",
        "Longest Week Streak" => "Найдаўжэйшая Тыднёвая Серыя",
        "Present" => "Цяпер",
        "Excluding {days}" => "Акрамя {days}",
    ],
    "bs" => [
        "Total Contributions" => "Ukupno Doprinosa",
        "Current Streak" => "Trenutni Niz",
        "Longest Streak" => "Najduži Niz",
        "Week Streak" => "Sedmični Niz",
        "Longest Week Streak" => "Najduži Sedmični Niz",
        "Present" => "Trenutno",
        "Excluding {days}" => "Isključujući {days}",
    ],
    "hr" => [
        ...
        "Current Streak" => "Trenutni Niz",
        "Longest Streak" => "Najduži Niz",
        "Week Streak" => "Tjedni Niz",
        "Longest Week Streak" => "Najduži Tjedni Niz",
        "Present" => "Sada",
        "Excluding {days}" => "Isključujući {days}",
    ],
    "cs" => [
        "Total Contributions" => "Celkový Počet Příspěvků",
        "Current Streak" => "Aktuální Série",
        "Longest Streak" => "Nejdelší Série",
        "Week Streak" => "Týdenní Série",
        "Longest Week Streak" => "Nejdelší Týdenní Série",
        "Present" => "Současnost",
        "Excluding {days}" => "Kromě {days}",
    ],
    "et" => [
        "Total Contributions" => "Panused Kokku",
    ...
    "fi" => [
        "Total Contributions" => "Kontribuutiot Yhteensä",
        "Current Streak" => "Nykyinen Putki",
        "Longest Streak" => "Pisin Putki",
        "Week Streak" => "Viikkoputki",
        "Longest Week Streak" => "Pisin Viikkoputki",
        "Present" => "Nykyhetki",
        "Excluding {days}" => "Pois lukien {days}",
    ],
    "gl" => [
        "Total Contributions" => "Contribucións Totais",
        "Current Streak" => "Racha Actual",
        "Longest Streak" => "Racha Máis Longa",
        "Week Streak" => "Racha Semanal",
        "Longest Week Streak" => "Racha Semanal Máis Longa",
        "Present" => "Presente",
        "Excluding {days}" => "Excluíndo {days}",
    ],
    "ka" => [
        "Total Contributions" => "მთლიანი წვლილი",
        "Current Streak" => "მიმდინარე სერია",
        "Longest Streak" => "ყველაზე გრძელი სერია",
        "Week Streak" => "კვირის სერია",
        "Longest Week Streak" => "ყველაზე გრძელი კვირის სერია",
        "Present" => "ამჟამად",
        "Excluding {days}" => "გარდა {days}",
    ],
    "is" => [
        "Total Contributions" => "Heildarframlög",
        "Current Streak" => "Núverandi Runa",
        "Longest Streak" => "Lengsta Runa",
        "Week Streak" => "Vikuruna",
        "Longest Week Streak" => "Lengsta Vikuruna",
        "Present" => "Nú",
        "Excluding {days}" => "Að undanskildum {days}",
    ],
    "km" => [
        "Total Contributions" => "ការរួមចំណែកសរុប",
        "Current Streak" => "ស្ទ្រីកបច្ចុប្បន្ន",
        "Longest Streak" => "ស្ទ្រីកវែងបំផុត",
        "Week Streak" => "ស្ទ្រីកប្រចាំសប្តាហ៍",
        "Longest Week Streak" => "ស្ទ្រីកប្រចាំសប្តាហ៍វែងបំផុត",
        "Present" => "បច្ចុប្បន្ន",
        "Excluding {days}" => "លើកលែង {days}",
    ],
    "lo" => [
        "Total Contributions" => "ການປະກອບສ່ວນທັງໝົດ",
        "Current Streak" => "ຊຸດປັດຈຸບັນ",
        "Longest Streak" => "ຊຸດຍາວທີ່ສຸດ",
        "Week Streak" => "ຊຸດອາທິດ",
        "Longest Week Streak" => "ຊຸດອາທິດຍາວທີ່ສຸດ",
        "Present" => "ປັດຈຸບັນ",
        "Excluding {days}" => "ຍົກເວັ້ນ {days}",
    ],
    "lv" => [
        "Total Contributions" => "Kopējais Ieguldījums",
        "Current Streak" => "Pašreizējā Sērija",
        "Longest Streak" => "Garākā Sērija",
        "Week Streak" => "Nedēļas Sērija",
        "Longest Week Streak" => "Garākā Nedēļas Sērija",
        "Present" => "Tagad",
        "Excluding {days}" => "Izņemot {days}",
    ],
    "lt" => [
        "Total Contributions" => "Viso Įnašų",
        "Current Streak" => "Dabartinė Serija",
        "Longest Streak" => "Ilgiausia Serija",
        "Week Streak" => "Savaitės Serija",
        "Longest Week Streak" => "Ilgiausia Savaitės Serija",
        "Present" => "Dabar",
        "Excluding {days}" => "Išskyrus {days}",
    ],
    "mk" => [
        "Total Contributions" => "Вкупно Придонеси",
        "Current Streak" => "Тековна Серија",
        "Longest Streak" => "Најдолга Серија",
        "Week Streak" => "Неделна Серија",
        "Longest Week Streak" => "Најдолга Неделна Серија",
        "Present" => "Сега",
        "Excluding {days}" => "Исклучувајќи {days}",
    ],
    "mt" => [
        "Total Contributions" => "Kontribuzzjonijiet Totali",
        "Current Streak" => "Streak Kurrenti",
        "Longest Streak" => "L-Itwal Streak",
        "Week Streak" => "Streak tal-Ġimgħa",
        "Longest Week Streak" => "L-Itwal Streak tal-Ġimgħa",
        "Present" => "Preżenti",
        "Excluding {days}" => "Eskludendi {days}",
    ],
    "si" => [
        "Total Contributions" => "සම්පූර්ණ දායකත්වය",
        "Current Streak" => "වර්තමාන අඛණ්ඩතාව",
        "Longest Streak" => "දීර්ඝතම අඛණ්ඩතාව",
        "Week Streak" => "සතිපතා අඛණ්ඩතාව",
        "Longest Week Streak" => "දීර්ඝතම සතිපතා අඛණ්ඩතාව",
        "Present" => "වර්තමානය",
        "Excluding {days}" => "{days} හැර",
    ],
];
